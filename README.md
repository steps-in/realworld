...
<!--
  Ranking:
    ...
    22: Riot.js v3
-->
> _Sorted by popularity on Sun Nov 24 2019_
...
<!--
  Ranking:
    ...
    15: Koa / Knex
    16: Clojure / Polylith
    17: Go Clean Architecture
    18: Go / Echo
    19: Serverless AWS Lambda DynamoDB
    20: Scala & Play Framework
    21: Haskell / Yesod
    22: CakePHP
    23: GCP Cloud Functions + Datastore
    24: Moleculer
    25: Hapi.js
    26: F#
    27: Functional ASP.NET Core
    28: Kotlin + Javalin + Exposed
    29: Crystal (Onyx)
    30: Node / hapi pal
    31: Express w/ Bookshelf.js
    32: QEWD.js
    33: Ruby & Colmena
    34: Kotlin + http4k
    35: Feathers
